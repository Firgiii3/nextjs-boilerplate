        ...
        <section className="bg-white/10 rounded-xl p-8 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              const originalPriceNum = parseFloat(item.originalPrice.replace('$','')) * 15000;
              const formattedPrice = originalPriceNum.toLocaleString('id-ID');
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-3 text-xs text-gray-300">
                    Harga normal: {item.originalPrice} (~Rp{formattedPrice})
                  </div>
